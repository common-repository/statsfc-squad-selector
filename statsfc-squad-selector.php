...
Plugin URI: https://statsfc.com/squad-selector
...
define('STATSFC_SQUADSELECTOR_VERSION', '1.2.2');
...
class StatsFC_SquadSelector extends WP_Widget
{
    ...
    public function widget($args, $instance)
    {
        ...
        $squad       = (array_key_exists('squad', $instance) ? $instance['squad'] : '');
        $orientation = (array_key_exists('orientation', $instance) ? $instance['orientation'] : '');
        ...
        try {
            ...
            wp_enqueue_script(STATSFC_SQUADSELECTOR_ID, plugins_url('script.js', __FILE__), null, STATSFC_SQUADSELECTOR_VERSION, true);
            ...
            $html .= <<< HTML
            <iframe id="statsfc-squad-selector" src="https://xi.statsfc.com/{$key}/{$squad}?orientation={$orientation}&amp;lang={$lang}" {$width} height="750" scrolling="no" frameborder="no"></iframe>
HTML;
        } catch (Exception $e) {
